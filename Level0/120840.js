...
// 실제로 테스트를 해 본 결과 share이 25 이상 일 때 몇몇 경우 for문을 오름차순으로 계산하는 경우와 내림차순으로 계산하는 경우의 값에 차이가 있는 것을 확인할 수 있었다.
// 이번 문제에서 이러한 문제점을 가장 쉽게 해결 할 수 있는 방법은 결과값에서 반올림을 해 주는 것이다.
